        ...
        if FORCE_SUB_CHANNEL:
            ...
            if not is_sub:
                keyboard = InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔔 Join Channel", url="https://t.me/log_channel_anuj")],
...
async def start(bot: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🔔 Channel", url="https://t.me/anujedits76"),
            InlineKeyboardButton("👨‍💻 Developer", url="https://t.me/Anujkumar_21")
        ]
    ])
